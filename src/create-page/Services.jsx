...
function Services() {
  ...
  return (
    <div id="service" className="font-roboto flex flex-col justify-center items-center mt-[80px] pb-[100px] text-white bg-gradient-to-tl from-[#9bc5c3] to-[#616161] rounded-t-4xl rounded-b-4xl">
      ...
      <div>
        <Link to={'/serviceep'}>
          <div className="flex mt-10 p-3 cursor-pointer transition-transform hover:scale-105 hover:shadow-2xl hover:border-2 hover:border-white hover:rounded-2xl" data-aos="fade-right" >
        ...
        <Link to={'/servicejz'}>
          <div className="flex mt-10 p-3 cursor-pointer transition-transform hover:scale-105 hover:shadow-2xl hover:border-2 hover:border-white hover:rounded-2xl" data-aos="fade-left">
