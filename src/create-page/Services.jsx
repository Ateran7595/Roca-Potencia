...
function Services() {
  ...
  return (
    <div
      id="service"
      className="font-roboto flex flex-col justify-center items-center mt-[80px] md:pb-[100px] xs:pb-[50px] text-white bg-gradient-to-tl from-[#9bc5c3] to-[#616161] rounded-t-4xl rounded-b-4xl"
    >
