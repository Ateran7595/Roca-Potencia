    ...
    return (
        <div>
            ...
            <div className="flex lg:flex-row xs:flex-col justify-center items-center lg:mt-[250px] md:mt-[180px] sm:mt-[120px] xs:mt-[80px] w-[80%] m-auto gap-15 mb-20">
                <div className="overflow-hidden pt-20" data-aos="fade-right">
                    <img
                        src={images[currentI]}
                ...
                <div className="lg:w-[50%] flex flex-col gap-4 font-roboto text-[23px] lg:text-start lg:text-[22px] xs:text-[18px]" data-aos="fade-left" >
