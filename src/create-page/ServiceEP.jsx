    ...
    <div className="bg-gradient-to-t from-[#dfe9f3] to-white ">
      ...
      <div className="mt-[200px] text-xl font-roboto text-center font-semibold animate">
        <div className="text-[30px]" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-offset="0">
          ...
          <p>11:00am - 1:30pm</p>
          <Button className="text-[22px] mt-3 font-bold h-[50px] rounded-[100px] border-2 border-black cursor-pointer">Mapa</Button>
        </div>
      </div>

      <div className='mt-15 mb-4 w-[30%] m-auto outline-3 rounded-xl' data-aos="fade-down">
        <h1 className='text-[30px] font-bold font-roboto text-center '>Clases Para Niños Desde Edades 3-10+</h1>
      </div>
      ...
      <div className='bg-[linear-gradient(-20deg,#616161_0%,#9bc5c3_100%)] rounded-t-2xl mt-10 text-white p-4'>
