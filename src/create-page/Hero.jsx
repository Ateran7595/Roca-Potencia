    ...
    <div className="bg-gradient-to-t from-[#dfe9f3] to-white">
      <div className="bg-[linear-gradient(-20deg,#616161_0%,#9bc5c3_100%)] flex flex-col items-center justify-center w-full p-5 h-[900px] relative">
        <div className="relative w-full flex items-center justify-center">
          <img src="/roca5.jpg" alt="roca5" className="w-[1300px] rounded-[50px] brightness-70 relative top-[150px] object-cover" />
          <div className="absolute text-[100px] text-white bottom-[610px] text-center">
            <h1 className="font-semibold">Roca & Potencia</h1>
            <p className="text-[36px] font-semibold outline">Todo es posible si puedes creer</p>
          </div>
        </div>
      </div>
      <div className="mt-[200px] text-xl font-roboto text-center font-semibold">
        ...
        <div className="mt-4 flex justify-center gap-5">
          <Button className="text-[22px] font-bold h-[50px] rounded-[100px] border-2 border-black">Proximos eventos</Button>
        </div>
      </div>
      <Services />
    </div>
